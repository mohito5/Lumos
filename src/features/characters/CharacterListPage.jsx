...
import CharacterListPageView from './views/CharacterListPageView';
...
/** @type {import('../../data/types.d.ts').Character[]} */
...
const CharacterListPage = () => {
    ...
    const avatarUrl = resolveIconUrl({ enkaIconMap: characterIcons }, character.id, character.avatar_icon);
