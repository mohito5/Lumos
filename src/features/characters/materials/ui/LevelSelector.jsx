...
import { LEVEL_MILESTONES, TALENT_LEVELS } from '../../../../shared/config/constants';
...
const LevelSelector = React.memo(({ type, from, to, onChange, t }) => {
    ...
    return (
        <div className="level-selector flex">
            <span className="selector-label">{t(`character.materials.${type}`, {ns:'ui'})}</span>
            <div className="level-control-wrapper flex">
