        ...
        <div className="enka-detail-block c">
            <div className="enka-detail-card c">
                ...
                <div className='weapon-icon ov-h bg-r'>
                    {iconSrc && <img loading="lazy" src={iconSrc} alt={weapon?.id ?? 'weapon'} className="enka-detail-icon" />}
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div className="enka-artifact-card b">
            ...
            <div className="enka-artifact-set-name">
                {artifact.icon && <img loading="lazy" src={`https://enka.network/ui/${artifact.icon}.png`} alt={slot} className='i bg-bl' />}
...
const EnkaBuildDetail = ({ build }) => {
    ...
    const portrait = character?.avatar_enka ?? character?.avatar;
                ...
                <article className='left'>
                    <div className='banner'>
                        <div className='character-banner wd ov-h'>
                            <img src={portrait} className="character-img" loading="lazy" />
                            <img src={portrait} className="character-back" loading="lazy" />
                            ...
                            {TALENT_KEYS.map((key) => {
                                ...
                                return (
                                    <div key={key} className="talent-item">
                                        {talentIcon ? (
                                            <img src={talentIcon} alt={key} className="talent-icon" loading="lazy" />
                                        ) : (
