...
import useCalculatorData from '../lib/useCalculatorData.js';
import { useDataManager } from '../../../../shared/lib/hooks/useDataManager.js';
import { calculateFinalStats } from '../../../../shared/lib/calculatorUtils.js';
import { LEVEL_MILESTONES as ASCENSION_LEVELS } from '../../../../shared/config/constants.js';
import { getArtifactSaveData, getArtifactFromSave } from '../lib/calculatorPageUtils.js';
