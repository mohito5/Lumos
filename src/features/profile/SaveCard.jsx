...
const SaveCard = ({ save, type, onDelete }) => {
    ...
    return (
        <div className="saved-material-card border">
            <div className="card-header flex">
                <img loading="lazy" src={avatar} alt={title} className="card-avatar icon-2xl border" onError={(e) => { e.target.onerror = null; e.target.src = '/assets/default-avatar.png'; }} />
                <div className="card-title-group wd">
                    <h4>{title}</h4>
