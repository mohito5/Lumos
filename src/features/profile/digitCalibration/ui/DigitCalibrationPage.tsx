...
import { useCvStatus } from '../../../../shared/lib/context/CvLoaderContext';
...
import { REGION_DEFAULTS } from '../../utils/opencv/region-calibration';
...
// Единственный источник этих чисел — region-calibration.ts (REGION_DEFAULTS,
// доли 0-1). Раньше здесь была независимая копия тех же значений ×100 —
// расхождение было лишь вопросом времени при следующей калибровке. Формула
// ниже — ровно то, что описано в шапке region-calibration.ts ("сам умножает
// на 100 при инициализации состояния").
const DEFAULT_PCT: RegionPercents = {
  containerTop: REGION_DEFAULTS.containerTop * 100,
  containerBottom: REGION_DEFAULTS.containerBottom * 100,
  iconH: REGION_DEFAULTS.iconH * 100,
  starsY: REGION_DEFAULTS.starsY * 100,
  starsH: REGION_DEFAULTS.starsH * 100,
  numY: REGION_DEFAULTS.numY * 100,
  numH: REGION_DEFAULTS.numH * 100,
};
