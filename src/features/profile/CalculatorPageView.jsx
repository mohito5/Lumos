        ...
        <div className="page calculator-page wd">
            <MasonryGrid>
                ...
                <div className="calculator-left grid-item" column={1}>
                    ...
                    <section className="calculator-section grid-item" column={1}>
                ...
                <div className="calculator-right grid-item" column={2}>
                    <section className="calculator-section artifacts-section">
                ...
                <section className="calculator-section final-stats-section">
