...
import { ENEMIES_TYPE, ELEMENT, FAMILY } from '../../constants/creatures.js';
import './date.css';
...
const CreaturesPage = () => {
    ...
    return (
        <div className="page date-subpage flex-c gap-4">
            <div className="date-subpage-header  gap-4 flex-c">
                <h1>{t('archive.creatures.title', { ns: 'ui' })}</h1>
                <p>{t('creatures.description', { ns: 'ui' })}</p>
