...
import { useAppStore } from './shared/lib/store/useAppStore.js';
import telegramHelper from './core/services/telegram.js';
import { initErrorTracking } from './core/services/errorTracking';

import './core/styles/index.css';
import './assets/styles/main.css';
import './core/styles/base.css';
import './core/styles/components/list.css';

// No-op без VITE_SENTRY_DSN (см. errorTracking.ts) — не блокирует рендер,
