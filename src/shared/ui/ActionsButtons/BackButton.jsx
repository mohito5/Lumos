...
const BackButton = () => {
    ...
    return (
        <button className='tooltip back-button p-2 border radius-4 color-pine bg-bl' onClick={handleBack} aria-label={t('buttons.go_back')}>
            <svg className='icon-mini'><use href="#icon-back"></use></svg>
