...
import { useFilterPanel } from '../../lib/context/ButtonManagerContext';
...
const FilterButton = () => {
    ...
    const buttonClasses = [
        'button tooltip flex-c p-2 border radius-4 bg-bl color-pine',
    ...
    return (
        ...
        >
            <svg className='icon-mini c-p'><use href="#icon-filter"></use></svg>
