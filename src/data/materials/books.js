import { MATERIAL_TIER, MATERIAL_FAMILY, REGION, DAYS, MATERIAL_TYPE, MATERIAL_GROUP, RARITY } from '../../app/constants';
...
export const books = [
    ...
    },
    {
        ...
        sid: 'm4',
        icon: "assets/book/resistance1.png",
        ...
        family: MATERIAL_FAMILY.RESISTANCE,
        region: REGION.MONDSTADT
    },
    {
        id: 'teachings_of_ballad',
        sid: 'm5',
        icon: "assets/book/ballad1.png",
